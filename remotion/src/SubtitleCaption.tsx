...
function mergeToWords(captions: Caption[]): WordToken[] {
...
function createPages(words: WordToken[], maxWordsPerPage: number): WordPage[] {
...
export const SubtitleGenerator: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#000" }}>
      <Video src={staticFile("video_to_subtitle.mp4")} />
